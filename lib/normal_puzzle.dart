...
class normal_puzzle extends StatefulWidget {
  int c_index;

  normal_puzzle(this.c_index);

  @override
  State<normal_puzzle> createState() => _normal_puzzleState();
}

class _normal_puzzleState extends State<normal_puzzle> {
  List img = [];
  List image1 = [];
  List<bool> temp = [];
  int a = 5, x = 1, pos1 = 0, pos2 = 0, c = 30;
  int cnt = 0;
