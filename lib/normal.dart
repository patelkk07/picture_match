...
class _normalState extends State<normal> {
  ...
  void initState() {
    ...
    for (int i = 0; i < 60; i++) {
      leval[i] = dashboard.preferences!.getString("Normal${i}") ?? "Panding";
      setState(() {});
    }
  }
                                ...
                                return InkWell(
                                  ...
                                  child: Container(
                                    ...
                                    child: Text(
                                      (leval[(myindex * 10) + index + 1] ==
                                              "win")
                                          ? "LEVEL ${(myindex * 10) + index + 1} - ${dashboard.preferences!.getInt("nsecond${(myindex * 10) + index + 1}")}"
